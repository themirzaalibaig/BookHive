...
function NewsPapers_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	// print preview?
	$dvprint = false;
	if($selected_id && isset($_REQUEST['dvprint_x']) && $_REQUEST['dvprint_x'] != ''){
		$dvprint = true;
	}
	...
	$templateCode = str_replace('<%%EMBEDDED%%>', (isset($_REQUEST['Embedded']) ? 'Embedded=1' : ''), $templateCode);
	// process buttons
	if($AllowInsert){
	...
	if($selected_id){
	if(!isset($_REQUEST['Embedded'])) $templateCode = str_replace('<%%DVPRINT_BUTTON%%>', '<button type="submit" class="btn btn-default" id="dvprint" name="dvprint_x" value="1" onclick="$$(\'form\')[0].writeAttribute(\'novalidate\', \'novalidate\'); document.myform.reset(); return true;" title="' . html_attr($Translation['Print Preview']) . '"><i class="glyphicon glyphicon-print"></i> ' . $Translation['Print Preview'] . '</button>', $templateCode);
		if($AllowUpdate){
	...
	foreach($lookup_fields as $luf => $ptfc){
		...
		if($pt_perm['insert'] && !isset($_REQUEST['Embedded'])){
	...
	if(isset($_REQUEST['dvprint_x']) && $_REQUEST['dvprint_x'] == ''){
		$templateCode .= "\n\n<script>\$j(function(){\n";
